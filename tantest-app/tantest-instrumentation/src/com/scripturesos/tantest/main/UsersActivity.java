...
public class UsersActivity extends Application  //implements SensorEventListener  
{
    ...
    */
	...
	public void findContact(Drawable bg)
	{
		...
		{
			((RelativeLayout) findViewById(R.id.users_container)).setBackground(bg);
		}
		...
		(new Thread() {
			...
			public void run() 
			{
				try 
				{
					...
					JSONObject response = HttpUtil.get(HttpUtil.getURL(HttpUtil.RANDOM, new String[]{"id",UsersUtil.UEMAIL}));
