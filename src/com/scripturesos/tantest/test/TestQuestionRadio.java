...
public class TestQuestionRadio implements TestQuestion{
	...
	public void initQuestion(JSONObject jsonQuestion) throws JSONException, TestException
	{
		...
		solution = new TestSolutionRadio();
		
		solution.setSolutionADT(jsonQuestion.getString("sol"));
	}
