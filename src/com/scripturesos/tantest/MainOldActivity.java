...
public class MainOldActivity extends Activity 
{

	public class MainActivityHandler extends Handler 
	{
        private MainOldActivity parent;

        public MainActivityHandler(MainOldActivity parent) 
        {
            this.parent = parent;
        }
	...
	public void loginGUI()
	{
		...
		countriesContainer.setOnItemClickListener(new OnItemClickListener()
		{
		    ...
		    { 
		    	abbr = MainOldActivity.abbreviations[position];
	...
	public void test(View view)
	{
		...
		Thread startTest = new Thread() {
			...
			public void run() 
			{
				Intent intent = new Intent(MainOldActivity.this, TestActivity.class);
	...
	public void goHome(boolean db)
	{
		...
		startActivity(new Intent(MainOldActivity.this, HomeActivity.class));
		finish();
	}
	
	public void ifError(String txt)
	{
		Toast.makeText(MainOldActivity.this, txt, Toast.LENGTH_SHORT).show();
		loader.setVisibility(View.GONE);
		textCode.setVisibility(View.GONE);
		((ImageButton) findViewById(R.id.main_connect)).setEnabled(true);
		sms_register = false;
